...
def connect_to_db():
    try:
        db_connection = mysql.connector.connect(
            ...
            database="LA_ANALYSIS"    # Replace with your database name
        )
...
# Assuming view_option is determined earlier in the script
view_option = st.sidebar.selectbox("Select View Option", ["Information", "Other Options"])

if view_option == "Information":
